...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] selection:bg-white/20">
      <section id="Hero-Section" className="relative flex flex-col items-center overflow-hidden px-4 pb-24 pt-40 text-center">
        <HoleBackground
       ...
       {/* BROWSER MOCKUP */}
      <section id="Browser-Section" className="px-4 pb-32">
        <div className="mx-auto max-w-5xl overflow-hidden rounded-2xl border border-white/8 bg-[#0f0f0f] shadow-2xl shadow-black/60">
          <div className="flex items-center gap-2 border-b border-white/6 px-4 py-3">
            ...
            <div className="mx-auto flex h-6 w-64 items-center justify-center rounded-md bg-white/5 px-3">
              <span className="text-xs text-white/25">Codexa.app/workspace</span>
            </div>
          </div>
                    ...
                    <SignInButton mode="modal">
                      <Button
                        className={cn(
                          ...
                          plan.featured
                            ? "bg-blue-500 text-white hover:bg-blue-400 active:scale-95"
                            : "border border-white/10 bg-transparent text-white/60 hover:bg-white/6 hover:text-white/90 cursor-pointer"
                        )}
                        variant="ghost"
                      >
                        Get started
      ...
      <section className="relative mx-auto mb-32 max-w-5xl overflow-hidden rounded-2xl border border-white/8 px-10 py-24 text-center">
        ...
        <SignInButton mode="modal">
          <Button
            size="lg"
            className="relative h-11 rounded-full bg-white px-8 cursor-pointer"
          >
            Get started free
